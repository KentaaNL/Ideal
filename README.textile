...
Note that this implementation was started a few years ago. This library support iDEAL version 3.3.1.

h2. Install

The iDEAL gem does not have any large external dependencies. It depends on RestClient (a simple HTTP/REST library), Nokogiri (for building XML files) and xmldsig. Because of these minor dependencies it's suited to use in Ruby projects other than Ruby on Rails.
...
git clone --depth 1 git://github.com/Mobillion/Ideal.git ideal</code></pre>
...
<pre><code>git clone --depth 1 git://github.com/Mobillion/Ideal.git ideal
cd ideal
...
If you find anything wrong with the gem, we would love to hear from you. Please "create an issue with a patch":https://github.com/Mobillion/iDeal/issues if you run into anything.
